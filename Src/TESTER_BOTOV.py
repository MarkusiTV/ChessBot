...
import SimpleChess_0_6
import SimpleChess_0_61
import SimpleChess_0_7
...
for i in range(int(hier)):
    board = chess.Board()
    result = play_chess_bot_vs_bot(board, SimpleChess_0_2.play_chess_opponent_bot, SimpleChess_0_7.get_best_move)
...
play_chess_bot_vs_bot(board, SimpleChess_0_2.play_chess_opponent_bot, SimpleChess_0_7.get_best_move)